...
$registros=mysqli_query($conexion, "select idDependencias from dependencias

                        where idDependencias='$id'") or 

  die("Problemas en el select:".mysqli_error($conexion));

if ($reg=mysqli_fetch_array($registros))
{
  mysqli_query($conexion,"DELETE FROM dependencias WHERE idDependencias='$id' ") or die("Problemas en el select:".mysqli_error($conexion));
