...
$registros=mysqli_query($conexion, "select idUsuarios from usuarios

                        where idUsuarios='$id'") or 

  die("Problemas en el select:".mysqli_error($conexion));

if ($reg=mysqli_fetch_array($registros))
{
  mysqli_query($conexion,"DELETE FROM usuarios WHERE idUsuarios='$id' ") or die("Problemas en el select:".mysqli_error($conexion));
